...
const CACHE_NAME = "vm-radio-app-v43";
const APP_SHELL = [
  "./",
  "./index.html",
  "./dedicaces.html",
    ...
    fetch(event.request, { cache: "no-store" }).then(async response => {
      ...
      if (url.pathname.endsWith("/index.html") || url.pathname === "/") {
        ...
        if (type.includes("text/html")) {
          ...
          if (!injected.includes("./dedications-feed.js")) injected = injected.replace(/<\/body>/i, '<script src="./dedications-feed.js?v=4"></script></body>');
