/* VM RADIO — blocage maintenance application v2 */
(function(){
  'use strict';
  ...
  function start(){
    ...
    setInterval(function(){if(active){stopMedia();ensureOverlay();}},1000);
  }
