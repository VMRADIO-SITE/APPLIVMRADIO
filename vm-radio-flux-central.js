...
(function(){
  ...
  core.src='vm-radio-flux-central-core.js?v=20260907-jingle-art-v16';
  core.async=false;
...
(function(){
  ...
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',startMaintenanceWatch,{once:true});
  else startMaintenanceWatch();
